...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const subject = encodeURIComponent('Zapytanie ze strony Front-Lak');
    ...
    window.location.href = `mailto:lakierowanie.frontow.mdf@gmail.com?subject=${subject}&body=${body}`;
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            <div className="bg-gradient-to-br from-amber-400/10 to-amber-400/5 border border-amber-400/20 rounded-xl p-7">
              ...
              <p className="text-zinc-400 text-sm mb-4">
                Zadzwoń bezpośrednio – odpowiemy na wszystkie pytania i ustalimy szczegóły zlecenia.
              </p>
              <a
                href="tel:513676682"
          ...
          <div className="lg:col-span-3">
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-7 md:p-10">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                ...
                <button
                  type="submit"
                  className="flex items-center justify-center gap-2 bg-amber-400 hover:bg-amber-300 text-zinc-950 font-bold py-4 rounded transition-all duration-200 hover:-translate-y-0.5"
                >
                  <Send size={18} />
                  Wyślij zapytanie
                </button>
